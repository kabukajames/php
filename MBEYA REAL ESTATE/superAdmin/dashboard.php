...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto md:flex">
        ...
        <div id="mainSidebar" class="bg-gray-800 text-white md:w-64 py-4 hidden md:block">
            <div class="p-4">
                ...
                <ul>
                    ...
                    <li class="mb-2">
                        <a href="../users/create.php" class="flex items-center py-2 px-4 rounded hover:bg-gray-700">
                            <span class="mr-2">👤</span> User accounts
                        </a>
                    </li>
                    
                    <li class="mb-2">
                        <a href="../roles/create.php" class="flex items-center py-2 px-4 rounded hover:bg-gray-700">
                    ...
                    <li class="mb-2">
                        <a href="#" class="flex items-center py-2 px-4 rounded hover:bg-gray-700">
                            <span class="mr-2">🏠</span> Property Managers
                        </a>
                    </li>
        ...
        <div id="propertyAdminSidebar" class="bg-gray-800 text-white md:w-64 py-4 hidden md:block">
            <div class="p-4">
                <h2 class="text-xl font-bold mb-4">Property Admin</h2>
                <ul>
                   
                    <li class="mb-2">
                        <a href="#" class="flex items-center py-2 px-4 rounded hover:bg-gray-700">
                            <span class="mr-2">🔑</span> Superadmin profile
                        </a>
                    </li>
                </ul>
            </div>
